  ...
  return (
    <>
      <Wrapper>
        ...
        <Container>
          <JobCard Job={{ title: "Hellow", salary: "12344",location:"Remote",description:["lan lele mera"],tags:["a","b","c"] }} />
          ...
          <p>
            ...
            you. As a volunteering intern, you will be given four different
            tasks for different weeks, you will be required to do social work
            near your area and spread positivity, and share the photos and
            videos of that social work on your social media, you will also be
            supporting the organization by raising funds and encouraging your
            friend to accompany you in this internship. You will support our
            organization's efforts to encourage volunteering and contribute to
          ...
          <ol>
            ...
            <List>
              Are from or open to relocate to Gurgaon and neighbouring cities{" "}
            </List>
          </ol>
